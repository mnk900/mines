            ...
            <div class="card-body" style="overflow:auto;">
                ...
                <table class="table table-sm table-striped" >
                    ...
                    <tr>
                        ...
                        <td><img src="{{ Storage::url($post->post_image_thumbnail) }}"></td>
                        <td>
                            <a href="{{ route('blog.edit',['blog'=>$post->id]) }}" class="btn btn-primary"><i
                                    class="fas fa-edit"></i></a>
                            <a href="{{ route('blog.destroy', ['blog' => $post->id]) }}" class="btn btn-danger delete-post"
