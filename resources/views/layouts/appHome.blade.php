...
<head>
  ...
  <style>
    ...
    .page-wrapper {
        ...
        .content-wrapper {
            flex: 1; /* This will make the content area grow and fill available space */
            /* min-height: calc(100vh - 120px); Adjust min-height to account for header and footer heights */
            padding: 20px;
        }
...
<body id="home" data-spy="scroll" data-target="#main-nav">
  <div class="page-wrapper">
    <!--Navbar-->
    <nav id="main-nav" class="navbar navbar-expand-lg navbar-light fixed-top" style="height: 57px;">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
          <ul class="navbar-nav ml-auto">
            ...
            <li style="float: right;">
              <div class="four columns">
                <a href="{{ route('login') }}" class="login-btn" style="margin-left:10px"><i class="fa fa-user"></i> Login</a>
              </div>
            </li>
          </ul>
        </div>
