    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/applications/leaseapplications/{{ Auth::user()->name }}" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="/checklist-reconnaissancelicense" class="nav-link">
              ...
              <p>
              Checklist  Reconnaissance License
              </p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="/checklist-depositretensionlicense" class="nav-link">
              <i class="nav-icon fas fa-list fa-xs"></i>
              <p>
              Checklist Mineral Deposit Retension License
              </p>
            </a>
          </li>
