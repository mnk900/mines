...
class ApplicationsController extends Controller
{
    ...
    public function generatechallan(Request $request)
    {
        ...
        return view('admin.applications.generatechallans', [
            'appid' => $app_id,
            'coordinatedata' => $coordinateData,
            'challanfees' => $challanfee,
            'barcode' => $barcode1D,
            'ranAl' => $randomAlphabets,
            'applicantcompleteData' => $applicantCompleteData,
            'user_email' => $user_email
        ]);
    }

    public function viewAppStatus(Request $request)
    {
        $app_id = $request->appid;
        $loginuser = auth()->user();
        $user_id = $loginuser->id;
        ...
        // dd($applicantCompleteData);
        return view('admin.applications.lease_status', ['applicantdata' => $applicantData, 'coordinatedata' => $coordinateData, 'applicantcompleteData' => $applicantCompleteData, 'appid' => $app_id]);
    }
    ...
    public function getExistingChallans(Request $request)
    {
        ...
        $application = DB::table('lease_application_registrations')
            ...
            ->select(
                ...
                'challans_generated.*',
                'challan_fees.*',
                'challans_generated.created_on as challan_date'
            )
